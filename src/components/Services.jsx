  ...
  return (
    <div className=" min-h-screen flex flex-col justify-center items-center lg:px-32 px-5 bg-backgroundColor">
      ...
      <div className=" flex flex-wrap items-center justify-center gap-5 mt-4">
        ...
        <ServicesCard icon={icon2} title="calculadora" />
        <ServicesCard icon={icon3} title="calculadora-imc" />
        <ServicesCard icon={icon4} title="Microsoft-Azure" />
        <ServicesCard icon={icon5} title="Donkey game test" />
        <ServicesCard icon={icon6} title="Portifolio" />
      </div>
    </div>
  );
};
